...
public class KeyCodeConverter {
	...
	/**
	 * For any supplied letter (case insensitive), 
	 * the corresponding keycode, as defined in the 
	 * KeyEvent class, is returned.
	 * 
	 * @param character The letter (A-Z)
	 * 
	 * @return The keycode for the letter or -1 if any other character is supplied
	 */
	public final static int getKeyCode(char character) {
		switch (character) {
