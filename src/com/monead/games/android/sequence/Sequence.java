...
public class Sequence extends Activity implements OnTouchListener {
    /**
     * The minimum SDK that uses the new onPrepareDialog()
     * method.
     */
     ...
     */
    private static final String SERIALIZED_MODEL_FILE_NAME = 
            "Sequence_Model.ser";
     ...
     * 
     * @param savedInstanceState The bundle saved when the program last ran
     */
    @Override
            ...
            if (out != null) {
                try {
                    ...
                    Log.e(className,
                            ...
                            .getString(
                            R.string.
                            errormessage_model_output_file_close_failed),
                            throwable);
                }
            }
        }
                ...
                if (in != null) {
                    try {
                        ...
                        Log.e(className,
                                ...
                                .getString(
                                R.string.
                                errormessage_model_input_file_close_failed),
                                throwable);
                    }
                }
            }
            ...
            if (out != null) {
                try {
                    ...
                    Log.e(className,
                            ...
                            .getString(
                            R.string.
                            errormessage_stats_output_file_close_failed),
                            throwable);
                }
            }
        }
    ...
    private void loadGameStatistics() {
        ...
        try {
            ...
            Log.w(className,
                    getResources().getString(
                            R.string.
                            errormessage_stats_read_failed), 
                            throwable);
            ...
            if (in != null) {
                try {
                    ...
                    Log.e(className,
                            ...
                            .getString(
                            R.string.
                            errormessage_stats_input_file_close_failed),
                            throwable);
                }
            }
        }
     ...
     * 
     * @param id The dialog identifier
     * @param dialog The dialog about to be presented
     */
    @Override
     ...
     * @param id The dialog identifier
     * @param dialog The dialog about to be presented
     * @param bundle The bundle associated with this dialog
     */
    @Override
    protected final void onPrepareDialog(final int id, 
            final Dialog dialog, final Bundle bundle) {
        switch (id) {
            case DIALOG_WIN:
     ...
     * 
     * @param keyCode The key code of the entered character
     * @param event The event supplying the key code
     * 
     * @return Whether the event was handled
     */
    @Override
